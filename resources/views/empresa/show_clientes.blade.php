...
<div class="app-content">
  <div class="app-content-header">
    ...
    <a href="{{asset('/empresa/form_empresa_cliente')}}"> <button class="btn btn-primary delete-btn">Adicionar Cliente</button> </a> &nbsp  
    <a href="{{asset('empresa/export')}}"> <button class="btn btn-outline-warning">Download Excel</button> </a>
...
@foreach($criar_empresa as $empresa_clientes )
      ...
      <div class="products-row">
        ...
        <a href="{{asset('/empresa/edit/')}}/{{$empresa_clientes->id}}" class="btn btn-success edit-btn">
