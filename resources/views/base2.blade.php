...
<link rel="stylesheet" href="{{asset('/css/style_primo.css')}}">
...
<div class="app-container">
  <section class="navigation">
    <a href="#" class="app-link">PRIMÃO MOVEIS</a>
  ...
  <section class="app-actions">
    <div class="app-actions-line">
      <div class="search-wrapper">
        ...
        <input type="text" class="search-input" value="Cadeira">
  ...
  <!-- partial -->
    ...
    <script src="{{asset('/js/script_primo.js')}}"></script>
