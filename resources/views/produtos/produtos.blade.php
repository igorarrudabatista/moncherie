...
<div class="app-content">
  <div class="app-content-header">
    ...
    <a href="{{asset('/produtos/create')}}"> <button class="btn btn-primary delete-btn">Adicionar Produto</button> </a> &nbsp  
    <a href="{{asset('produtos/export')}}"> <button class="btn btn-outline-warning">Download Excel</button> </a>
...
@foreach($produtos as $Produto )
      ...
      <div class="products-row">
        ...
        <div class="product-cell price"><span class="cell-label">Preço: </span> <b> R$    {{$Produto->Preco_Produto}} </b> </div>
