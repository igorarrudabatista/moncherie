...
@section('content')
  <div class="app-content">
    ...
    <form action="{{asset('/usuarios/update/')}}/{{$usuario->id}}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')  
      <div class="form-row">
  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <div class="upload">
        <input type="file" title="" id="image" name="profile_photo_path"  class="drop-here">
