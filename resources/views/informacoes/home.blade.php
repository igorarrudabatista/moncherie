...
<div class="card" data-state="#about">
  <div class="card-header">
    ...
    <img class="card-avatar" src="{{asset('/img/info/logo.png')}}" alt="avatar" />
    <h1 class="card-fullname">Web Monkey</h1>
    <h2 class="card-jobtitle">Sistemas Web</h2>
  </div>
  <div class="card-main">
    <div class="card-section is-active" id="about">
      <div class="card-content">
        <div class="card-subtitle">SOBRE</div>
        <p class="card-desc">Estamos no mercado há mais de 5 anos, fornecendo visibilidade ao negócio de nossos clientes. Atuamos como sempre parceiros e membros da equipe. Venha fazer parte você também.
        </p> <br>
       <b> Sistema versão beta de
        uso gratuito. </b>
      ...
      <div class="card-content">
        ...
        <div class="card-contact-wrapper">
          ...
          <div class="card-contact">
            ...
            </svg>(65) 99800 - 7226 </div>
          <div class="card-contact">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <path d="M22 6l-10 7L2 6" /></svg>
            atendimento@webmonkey.com.br  
          </div>
