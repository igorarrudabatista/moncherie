    ...
    <div class="app-main-left cards-area">
      ...
      <div class="card-wrapper main-card">
        <a class="card cardItemjs"  onclick="openModal()">
          ...
          <div class="card-info">
            <div class="card-text big cardText-js">{{$Produto->Nome_Produto}}</div>
            <div class="card-text small">{{$Produto->Categoria_Produto}}</div>
            <div class="card-text small">
              Preço:
              <span class="card-price"> R$ {{$Produto->Preco_Produto}}</span>
            </div>
          </div>
          </a>
      </div>
    ...
    <div class="main-modal">
      <div class="modal-left">
        ...
        <div class="modal-info-header">
          ...
          Preço:
            <span class="amount">R$ {{$Produto->Preco_Produto}}</span>
          </div>
        </div>
        ...
        <div class="info-bar">
          <div class="info-wrapper">
            ...
            <span> Quantidade: {{$Produto->Quantidade_Produto}}</span>
          </div>
          <div class="info-wrapper">
            <div class="info-icon">
            ...
            <span>Estoque: {{$Produto->Estoque_Produto}}</span>
          </div>
          <div class="info-wrapper">
            <div class="info-icon">
